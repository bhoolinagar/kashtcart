...
class image_d extends StatefulWidget {
  _image_d createState() => _image_d();
}

class _image_d extends State<image_d> {
  ...
  Future<String> uploadItemImage(mfileImage) async {
    ...
    UploadTask uploadTask =
        storageReference.child('product_$uid.jpg').putFile(mfileImage);
