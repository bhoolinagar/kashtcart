...
class DSmobile extends StatefulWidget {
  @override
  DSmobileState createState() => DSmobileState();
}

class DSmobileState extends State<DSmobile> {
  ...
  void signInWithPhoneAuthCredential(
    ...
    try {
      ...
      if (authCredential?.user != null) {
        ...
        //   context,
        // MaterialPageRoute(
        //   builder: (context) => d_home(currentId: user.uid)));
      }
      ...
      children: [
        TextField(
          ...
          decoration: textInputDecoration.copyWith(
              prefixIcon:
                  Icon(Icons.person_sharp, size: 25, color: Color(0xff33a509)),
              hintText: "Enter name",
              labelText: 'Name',
              labelStyle: TextStyle(color: Color(0xff33a509)),
        ...
        MaterialButton(
          onPressed: () async {
            ...
            await _auth.verifyPhoneNumber(
              phoneNumber: country + phone.text,
      ...
      children: [
        ...
        TextField(
          ...
          decoration: textInputDecoration.copyWith(
              hintText: "Enter OTP",
              labelText: 'OTP',
              prefixIcon: Icon(Icons.lock, size: 25, color: Color(0xff33a509)),
              border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(25.0))),
        ),
        SizedBox(
          ...
          child: MaterialButton(
            onPressed: () async {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => d_home(currentId: uid)));
            },
        ...
        : Scaffold(
            ...
            body: Stack(
              children: <Widget>[
                ...
                Transform.translate(
                  ...
                  child: SizedBox(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(79.0, 15.0, 200.0, 200.0),
                          size: Size(394.6, 855.0),
                          pinLeft: true,
                          pinTop: true,
                          fixedWidth: true,
                          fixedHeight: true,
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  width: 05.0, color: const Color(0xffec8951)),
                            ),
                          ),
                        ),
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(72.9, 15.3, 210.0, 210.0),
                          size: Size(394.6, 855.0),
                          pinTop: true,
                          fixedWidth: true,
                          fixedHeight: true,
                ...
                //for third driver canvas

                Transform.translate(
                  offset: Offset(197.4, 670.1),
                  child: Transform.rotate(
                    angle: -1.3788,
                    child: Container(
                      width: 4.0,
...
// kashtcart logo in page
                Transform.translate(
                  offset: Offset(84.9, 157.3),
                  child: Transform.rotate(
                    angle: -0.0,
                    child:
                        // Adobe XD layer: 'TC' (shape)
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(17.0, 315.0, 400.0, 300.0),
                  size: Size(394.6, 855.0),
                  pinLeft: true,
                  pinTop: true,
                  fixedWidth: true,
                ...
                //bounds: Rect.fromLTWH(1.0, 100, 330, 435),
                //size: Size(387, 887),
                //pinLeft: true,
                //fixedHeight: true,
                //fixedWidth: true,
                ...
                //MaterialButton(
                //onPressed: () {
                //  PhoneloginUser(phone, verificationId);
                //  Navigator.of(context).pushReplacement(MaterialPageRoute
                //  (builder: (context)=> d_home(currentId: phone,)));
                //},
                //child: Container(
                //width: 140,
                //height: 40,
